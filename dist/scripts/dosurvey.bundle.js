...
/***/ function(module, exports, __webpack_require__) {
	...
	var Promise = window.Promise || __webpack_require__(24).Promise
	...
	function requestSurveyDetail() {
	  ...
	  .done(function(data) {
	    if (data.status === 'success') {
	      var _html = Handlebars.compile(__webpack_require__(18))(data.content)
	      $('#main').append(_html)
	    }
	  })
	}
	...
	function displayImages(files, zoom, upBtn, name) {
	  ...
	  Promise.all(filePromises).then(function(dataURL) {
	    ...
	    if (!$(zoom).html()) {
	      ...
	      var li_template = __webpack_require__(19)
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"yj-form-item\">\r\n  <label for=\"\" class=\"yj-label\">申请编号:</label>\r\n  <p class=\"yj-form-text\">{{applySerialNo}}</p>\r\n</div>\r\n<div class=\"yj-form-item\">\r\n  <label for=\"\" class=\"yj-label\">姓名:</label>\r\n  <p class=\"yj-form-text\">{{customerName}}</p>\r\n</div>\r\n<div class=\"yj-form-item\">\r\n  <label for=\"\" class=\"yj-label\">出生日期:</label>\r\n  <p class=\"yj-form-text\">{{birthDay}}</p>\r\n</div>\r\n<div class=\"yj-form-item\">\r\n  <label for=\"\" class=\"yj-label\">申请金额:</label>\r\n  <p class=\"yj-form-text\"><span class=\"am-rmb\">{{planBusinessSum}}</span>元</p>\r\n</div>\r\n<div class=\"yj-form-item\">\r\n  <label for=\"\" class=\"yj-label\">核定金额:</label>\r\n  <p class=\"yj-form-text\"><span class=\"am-rmb\">{{checkBusinessSum}}</span>元</p>\r\n</div>\r\n<div class=\"yj-form-item\">\r\n  <label for=\"\" class=\"yj-label\">问题描述:</label>\r\n  <p class=\"yj-form-text\">{{phaseOpinion}}</p>\r\n</div>\r\n"

/***/ },
/* 19 */
/***/ function(module, exports) {

	module.exports = "{{#each this}}\r\n<li>\r\n  <a class=\"am-close am-close-alt am-icon-times am-img-close\"></a>\r\n  <div class=\"am-gallery-item\"><img src={{img}}></div>\r\n</li>\r\n{{/each}}\r\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(31), (function() { return this; }()), __webpack_require__(30)(module)))
